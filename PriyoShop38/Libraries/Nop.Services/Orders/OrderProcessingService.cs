...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        /// <param name="customerPriyoCoinService">Customer Priyo Coin settings</param>
        public OrderProcessingService(
            ...
            ICustomerPriyoCoinService customerPriyoCoinService)
    ...
    //   string gid= _orderService.SaveMakePayment(order);
        ...
        public virtual void MarkOrderAsPaid(Order order)
        {
            ...
            {
                ProcessOrderPaid(order);
                var customerPriyoCoin = new CustomerPriyoCoin
                {
                    CustomerId = order.CustomerId,
                    PointNumber = (int?) Math.Ceiling(order.OrderTotal/ 100),
                    PointType = "DEBIT",
                    PointSourceDescription = "Order Completed Successfully",
                    Date = DateTime.UtcNow
                };
                _customerPriyoCoinService.InsertCustomerPriyoCoin(customerPriyoCoin);
            }
        }
